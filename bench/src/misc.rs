...
bench_captures!(short_haystack_20x,
    Regex::new(r"(bbbb)cccc(bbb)").unwrap(), 2,
    format!("{}bbbbccccbbb{}",
            repeat("aaaa").take(20).collect::<String>(),
            repeat("dddd").take(20).collect::<String>(),
            ));
bench_captures!(short_haystack_30x,
    Regex::new(r"(bbbb)cccc(bbb)").unwrap(), 2,
    format!("{}bbbbccccbbb{}",
            repeat("aaaa").take(30).collect::<String>(),
            repeat("dddd").take(30).collect::<String>(),
            ));
bench_captures!(short_haystack_40x,
    Regex::new(r"(bbbb)cccc(bbb)").unwrap(), 2,
    format!("{}bbbbccccbbb{}",
            repeat("aaaa").take(40).collect::<String>(),
            repeat("dddd").take(40).collect::<String>(),
            ));
