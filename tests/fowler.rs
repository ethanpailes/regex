...
// TODO(ethan): move to a real place
// Instead of dying this should match when there is a failure
// in the second "ab" bit. This seems to hint at some deeper
// problems though.
mat!(trailing_repeat, "ab(?:ab)?", "abac", Some((0, 2)));
mat!(trailing_alt_with_empty_branch, "ab(?:ab|)", "abac", Some((0, 2)));
mat!(match_basic_1_, r"a+?", r"aa", Some((0, 1)));
